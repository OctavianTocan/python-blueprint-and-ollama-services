...
class OllamaOptions(BaseModel):
    ...
    num_predict: int = Field(default=-1, ge=-1, description="Maximum tokens to generate")
...
class OllamaResponse(BaseModel):
    ...
    done: Optional[bool] = Field(default=None, description="Whether generation is complete")
